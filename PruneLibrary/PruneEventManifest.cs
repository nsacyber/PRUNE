...
namespace PruneEvents
{
    ...
    public static class PRUNE_EVENT_PROVIDER
    {
        ...
        //
        public static bool EventWritePROCESS_REPORT_EVENT(string Process, uint Samples, string ComputerManufacturer, string ComputerModel, string ComputerProcessorNum, string RamSize, uint ProcessorCount, uint DiskCount, string Processors, string Disks, double ProcessorTimePercentMinimum, double ProcessorTimePercentMaximum, double ProcessorTimePercentAverage, long WorkingSetMinimum, long WorkingSetMaximum, long WorkingSetAverage, long PrivateBytesMinimum, long PrivateBytesMaximum, long PrivateBytesAverage, long DiskBytesReadTotal, long DiskBytesReadMinimum, long DiskBytesReadMaximum, long DiskBytesReadAverage, long DiskBytesWrittenTotal, long DiskBytesWrittenMinimum, long DiskBytesWrittenMaximum, long DiskBytesWrittenAverage, long DiskReadOperationTotal, long DiskReadOperationMinimum, long DiskReadOperationMaximum, long DiskReadOperationAverage, long DiskWriteOperationTotal, long DiskWriteOperationMinimum, long DiskWriteOperationMaximum, long DiskWriteOperationAverage, long TcpBytesReceivedTotal, long TcpBytesReceivedMinimum, long TcpBytesReceivedMaximum, long TcpBytesReceivedAverage, long TcpBytesSentTotal, long TcpBytesSentMinimum, long TcpBytesSentMaximum, long TcpBytesSentAverage, long UdpBytesReceivedTotal, long UdpBytesReceivedMinimum, long UdpBytesReceivedMaximum, long UdpBytesReceivedAverage, long UdpBytesSentTotal, long UdpBytesSentMinimum, long UdpBytesSentMaximum, long UdpBytesSentAverage, uint TcpConnectionCount, string TcpConnections)
        {
