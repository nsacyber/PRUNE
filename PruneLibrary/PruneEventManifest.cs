    ...
    internal class EventProviderVersionTwo : EventProvider
    {
            ...
            )
        {
            ...
            if (IsEnabled(eventDescriptor.Level, eventDescriptor.Keywords))
            {
                ...
                userDataPtr[3].DataPointer = (UInt64)(&Processor);
                userDataPtr[3].Size = (uint)(Processor_Len_  );
                ...
                userDataPtr[7].DataPointer = (UInt64)(&DiskCount);
                userDataPtr[7].Size = (uint)(sizeof(int)  );

                userDataPtr[8].DataPointer = (UInt64)(&Disk);
                userDataPtr[8].Size = (uint)(Disk_Len_  );
                ...
                userDataPtr[51].DataPointer = (UInt64)(&TcpConnectionsCount);
